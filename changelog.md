...
* **[UX]** The Payload tab can pin a flight's board number: the lead takes the number entered and the wingmen follow in order (105, 106, 107, 108). A number another flight of the coalition holds is refused, and no other aircraft is given a pinned number. (#874)
