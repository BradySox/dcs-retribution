...
from game.missiongenerator.dtc.elevations import control_point_elevation
    ...
    return [
        {
            ...
            "x": cp.position.x,
            "y": cp.position.y,
            # A boat or a FOB has no field elevation on record and reads 0.
            "alt": control_point_elevation(game, cp) or 0.0,
